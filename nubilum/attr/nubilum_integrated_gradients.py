...
class NubilumIntegratedGradients(IntegratedGradients):
    ...
    def attribute(self,
        ...
        Args:
            inputs (TensorOrTupleOfTensorsGeneric): The input tensors for which integrated gradients is computed.
            baselines (TensorOrTupleOfTensorsGeneric, optional): Baseline tensors. Baseline tensors shapes must be equal to the input tensors. Defaults to None.
